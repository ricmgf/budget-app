/**
 * [BLOQUE_PROTEGIDO_V1.55] - MOTOR DE LÓGICA
 * ⚠️ NO DECLARAR CONSTANTES QUE YA EXISTAN EN CONFIG.JS.
 */
const BudgetLogic = {
  async loadConfig() {
    try {
      ...
      if (e.status === 403) alert("ERROR 403: Revisa los permisos de tu API Key o si la hoja es pública.");
