    ...
    <div class="card">
      ...
      <div style="margin-top:30px; padding-top:20px; border-top:1px solid var(--border-light);">
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap:10px; margin-top:10px;">
          <input type="text" id="new-acc-alias" placeholder="Alias" style="padding:8px; border-radius:6px; border:1px solid var(--border-light);">
        ...
        <button onclick="saveNewAccount()" style="margin-top:15px; padding:10px 20px; background:var(--accent); color:white; border-radius:8px; cursor:pointer; border:none; font-weight:700;">Guardar Banco</button>
      </div>
    </div>`;
}
