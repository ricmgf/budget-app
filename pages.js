...
async function loadDashboard() {
  ...
  try {
    ...
    container.innerHTML = `<div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:20px; margin-bottom:30px;">
...
window.saveBank = async function() {
  ...
  if (!n || !i) return alert("Campos obligatorios vacíos.");
...
window.addCardMaster = async function() {
  ...
  if (n) { alert("Añádela en la Columna E del Excel y refresca."); }
};
