/**
 * ============================================================
 * BUDGET APP — MASTER LOGIC ENGINE (v1.51)
 * ============================================================
 * [SEGURIDAD]: Basado en v1.34. NO DUPLICAR constantes si ya 
 * existen en config.js. Mapeo de Casas en Col D (index 3).
 */
...
const BudgetLogic = {
  async loadConfig() {
    try {
      ...
      rows.slice(1).forEach((row, index) => {
        ...
        // Col D: Tabla Maestra de Casas (NUEVA ESTRUCTURA)
  ...
  async getDashboardData(y, m) {
    ...
    const funding = {};
    planG.forEach(p => {
      // Legacy: Uso de índices directos para máxima velocidad (Col 5 Importe, Col 8 Cat)
