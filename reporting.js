...
const Reporting = (() => {
  ...
  async function loadData(force) {
    ...
    try {
      ...
      // Dos readSheet en paralelo — igual que el dashboard
      const [gRaw, iRaw] = await Promise.all([
        SheetsAPI.readSheet(CONFIG.SHEETS.GASTOS),
        SheetsAPI.readSheet(CONFIG.SHEETS.INGRESOS),
      ]);
